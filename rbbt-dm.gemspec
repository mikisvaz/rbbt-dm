...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/rbbt/matrix/test_barcode.rb".freeze, "test/rbbt/network/test_paths.rb".freeze, "test/rbbt/statistics/test_fdr.rb".freeze, "test/rbbt/statistics/test_fisher.rb".freeze, "test/rbbt/statistics/test_hypergeometric.rb".freeze, "test/rbbt/statistics/test_random_walk.rb".freeze, "test/rbbt/test_ml_task.rb".freeze, "test/rbbt/test_stan.rb".freeze, "test/rbbt/vector/model/huggingface/test_masked_lm.rb".freeze, "test/rbbt/vector/model/test_huggingface.rb".freeze, "test/rbbt/vector/model/test_pytorch_lightning.rb".freeze, "test/rbbt/vector/model/test_spaCy.rb".freeze, "test/rbbt/vector/model/test_svm.rb".freeze, "test/rbbt/vector/model/test_tensorflow.rb".freeze, "test/rbbt/vector/test_model.rb".freeze, "test/test_helper.rb".freeze]
