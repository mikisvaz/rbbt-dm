...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_helper.rb".freeze, "test/rbbt/test_stan.rb".freeze, "test/rbbt/vector/model/test_svm.rb".freeze, "test/rbbt/vector/test_model.rb".freeze, "test/rbbt/network/test_paths.rb".freeze, "test/rbbt/matrix/test_barcode.rb".freeze, "test/rbbt/statistics/test_fisher.rb".freeze, "test/rbbt/statistics/test_hypergeometric.rb".freeze, "test/rbbt/statistics/test_fdr.rb".freeze, "test/rbbt/statistics/test_random_walk.rb".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<priority_queue_cxx>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<priority_queue_cxx>.freeze, [">= 0"])
