...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_helper.rb".freeze, "test/rbbt/vector/model/test_svm.rb".freeze, "test/rbbt/vector/test_model.rb".freeze, "test/rbbt/network/test_paths.rb".freeze, "test/rbbt/statistics/test_random_walk.rb".freeze, "test/rbbt/statistics/test_fdr.rb".freeze, "test/rbbt/statistics/test_hypergeometric.rb".freeze]
